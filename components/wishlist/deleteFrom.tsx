...
export const DeleteWishListModal = ({ comp, callback }: { comp: company, callback: (a: String) => void }) => {
                        ...
                        <div className="relative w-auto my-6 mx-auto max-w-3xl">
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                ...
                                <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                                    <h3 className="text-3xl font-semibold">Delete {comp.name} from your wishlist?</h3>
                                    <button
                                ...
                                <div className="relative p-6 flex-auto">
                                    <p className="my-4 text-slate-500 text-lg leading-relaxed">
                                        If you delete {comp.name} from your wishlist, you will stop receiving updates when they change their privacy policy.
                                    </p>
                                </div>
                                {/*footer*/}
