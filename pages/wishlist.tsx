                    ...
                    <tbody>
                        {
                            companies.map((c) => {
                                return (<tr key={c.elId as string} className="companyRow relative bg-white border-b dark:border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-100 cursor-pointer" id={c.elId as string}>
                                    ...
                                    <td className="py-4">
                                        <button className="border border-blue-400 text-blue-400 font-bold uppercase text-xs px-6 py-3 rounded  hover:text-blue-600 outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150">View</button>
