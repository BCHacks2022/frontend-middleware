...
export default function Home() {
  ...
  return (
    <div className="screen w-full h-screen  justify-center bg-white my-5">
      <div className="container py-0 px-10 mx-0 min-w-full flex flex-col items-center">
        <h3 className="title-font mx-5 sm:text-3xl text-3xl mb- font-medium text-gray-900">
      ...
      <div class="inline-flex justify-center items-center w-full">
        ...
        <span class="absolute left-1/2 px-3 font-medium text-gray-500 bg-white -translate-x-1/2 dark:text-white dark:bg-gray-900">or</span>
      </div>
      ...
      <div className="flex justify-center items-center space-x-4">
        <textarea 
          id="text" rows={10} 
          className="p-7 mx-auto w-9/12 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
